...
Após autorização explícita do usuário, o pedido #5590000 (registrationId 18420002) foi marcado para exclusão pela rotina oficial do sistema, com a justificativa de vínculo indevido ao ADM. O procedimento respondeu sucesso e nenhum outro pedido ou cadastro foi alterado. A próxima etapa é remover permanentemente apenas esse item da lixeira do pedido, conforme a autorização do usuário.

A lixeira identificou apenas o registro do pedido #5590000 com registrationId 18420002. A exclusão permanente desse item foi executada pela rotina oficial e respondeu sucesso. A operação atingiu somente esse pedido. A validação final confirmará que ele não aparece mais na busca administrativa nem na área autenticada.
