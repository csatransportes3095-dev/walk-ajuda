...
function manusRuntimeDevOnly(): Plugin {
  ...
  return {
    ...
    transformIndexHtml(html: string, ctx: any) {
      if (!ctx || ctx.server === undefined) return html;
      return typeof innerTransform === "function" ? innerTransform.call(inner, html, ctx) : html;
    },
  };
}
...
export default defineConfig({
  ...
  build: {
    ...
    terserOptions: {
      ...
      format: {
        comments: false,
        // Critico para WhatsApp: o JS publicado não leva emojis literais. Eles saem
        // como escapes Unicode ASCII e são reconstruídos pelo navegador sem mojibake.
        ascii_only: true,
      },
    } as any,
  },
