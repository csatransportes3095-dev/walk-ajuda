...
// ========== H2 PARTICULAR — PASSAGEIROS PARTICULARES ==========
// Todas as entidades pertencem ao usuário autenticado da Planilha de Gastos.

export const privateClients = mysqlTable("privateClients", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  clientCode: varchar("clientCode", { length: 24 }).notNull().unique(),
  name: varchar("name", { length: 160 }).notNull(),
  phone: varchar("phone", { length: 32 }).notNull(),
  phoneNormalized: varchar("phoneNormalized", { length: 16 }).notNull(),
  whatsapp: varchar("whatsapp", { length: 32 }),
  cpf: varchar("cpf", { length: 14 }),
  cpfNormalized: varchar("cpfNormalized", { length: 11 }),
  email: varchar("email", { length: 320 }),
  ...
  referencePoint: varchar("referencePoint", { length: 255 }),
  latitude: decimal("latitude", { precision: 10, scale: 7 }),
  longitude: decimal("longitude", { precision: 10, scale: 7 }),
  notes: text("notes"),
  isFavorite: int("isFavorite").notNull().default(0),
  isFrequent: int("isFrequent").notNull().default(0),
  isActive: int("isActive").notNull().default(1),
  deactivatedAt: timestamp("deactivatedAt"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
export type PrivateClient = typeof privateClients.$inferSelect;
export type InsertPrivateClient = typeof privateClients.$inferInsert;

export const privateSettings = mysqlTable("privateSettings", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull().unique(),
  driverName: varchar("driverName", { length: 160 }),
  driverPhone: varchar("driverPhone", { length: 32 }),
  driverCpf: varchar("driverCpf", { length: 14 }),
  driverCity: varchar("driverCity", { length: 128 }),
  ...
  pixKey: varchar("pixKey", { length: 160 }),
  logoUrl: varchar("logoUrl", { length: 1024 }),
  minFare: decimal("minFare", { precision: 12, scale: 2 }).notNull().default("0"),
  minRatePerKm: decimal("minRatePerKm", { precision: 12, scale: 2 }).notNull().default("0"),
  ratePerHour: decimal("ratePerHour", { precision: 12, scale: 2 }).notNull().default("0"),
  ratePerMinute: decimal("ratePerMinute", { precision: 12, scale: 2 }).notNull().default("0"),
  waitRatePerMinute: decimal("waitRatePerMinute", { precision: 12, scale: 2 }).notNull().default("0"),
  profitMarginPercent: decimal("profitMarginPercent", { precision: 8, scale: 2 }).notNull().default("0"),
  overnightSurcharge: decimal("overnightSurcharge", { precision: 12, scale: 2 }).notNull().default("0"),
  airportSurcharge: decimal("airportSurcharge", { precision: 12, scale: 2 }).notNull().default("0"),
  holidaySurcharge: decimal("holidaySurcharge", { precision: 12, scale: 2 }).notNull().default("0"),
  longTripSurcharge: decimal("longTripSurcharge", { precision: 12, scale: 2 }).notNull().default("0"),
  tollPolicy: varchar("tollPolicy", { length: 16 }).notNull().default("separate"),
  appointmentBufferMinutes: int("appointmentBufferMinutes").notNull().default(30),
  reminderMinutesJson: text("reminderMinutesJson"),
  frequentTripThreshold: int("frequentTripThreshold").notNull().default(5),
  quoteValidityHours: int("quoteValidityHours").notNull().default(48),
  receiptFooter: text("receiptFooter"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
export type PrivateSettings = typeof privateSettings.$inferSelect;

export const privateQuotes = mysqlTable("privateQuotes", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  clientId: int("clientId").notNull(),
  quoteCode: varchar("quoteCode", { length: 24 }).notNull().unique(),
  publicToken: varchar("publicToken", { length: 96 }).notNull().unique(),
  publicLinkEnabled: int("publicLinkEnabled").notNull().default(1),
  publicLinkExpiresAt: timestamp("publicLinkExpiresAt"),
  status: varchar("status", { length: 32 }).notNull().default("RASCUNHO"),
  clientNameSnapshot: varchar("clientNameSnapshot", { length: 160 }).notNull(),
  clientPhoneSnapshot: varchar("clientPhoneSnapshot", { length: 32 }),
  ...
  stopsJson: text("stopsJson"),
  appointmentAt: timestamp("appointmentAt"),
  returnAt: timestamp("returnAt"),
  tripType: varchar("tripType", { length: 24 }).notNull().default("ONE_WAY"),
  waitMinutes: int("waitMinutes").notNull().default(0),
  distanceToPickupKm: decimal("distanceToPickupKm", { precision: 12, scale: 3 }).notNull().default("0"),
  passengerDistanceKm: decimal("passengerDistanceKm", { precision: 12, scale: 3 }).notNull().default("0"),
  totalDistanceKm: decimal("totalDistanceKm", { precision: 12, scale: 3 }).notNull().default("0"),
  estimatedDurationMinutes: int("estimatedDurationMinutes").notNull().default(0),
  estimatedFuelCost: decimal("estimatedFuelCost", { precision: 12, scale: 2 }).notNull().default("0"),
  estimatedTolls: decimal("estimatedTolls", { precision: 12, scale: 2 }).notNull().default("0"),
  estimatedParking: decimal("estimatedParking", { precision: 12, scale: 2 }).notNull().default("0"),
  estimatedOtherCosts: decimal("estimatedOtherCosts", { precision: 12, scale: 2 }).notNull().default("0"),
  estimatedCost: decimal("estimatedCost", { precision: 12, scale: 2 }).notNull().default("0"),
  recommendedPrice: decimal("recommendedPrice", { precision: 12, scale: 2 }).notNull().default("0"),
  finalPrice: decimal("finalPrice", { precision: 12, scale: 2 }).notNull().default("0"),
...
export const privateAppointments = mysqlTable("privateAppointments", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  clientId: int("clientId").notNull(),
  quoteId: int("quoteId"),
  ...
  tripType: varchar("tripType", { length: 24 }).notNull().default("ONE_WAY"),
  waitMinutes: int("waitMinutes").notNull().default(0),
  estimatedDistanceKm: decimal("estimatedDistanceKm", { precision: 12, scale: 3 }).notNull().default("0"),
  estimatedDurationMinutes: int("estimatedDurationMinutes").notNull().default(0),
  estimatedCost: decimal("estimatedCost", { precision: 12, scale: 2 }).notNull().default("0"),
  finalPrice: decimal("finalPrice", { precision: 12, scale: 2 }).notNull().default("0"),
  recurrenceRule: varchar("recurrenceRule", { length: 32 }),
  recurrenceUntil: timestamp("recurrenceUntil"),
  cancellationReason: text("cancellationReason"),
  cancelledAt: timestamp("cancelledAt"),
  cancelledBy: varchar("cancelledBy", { length: 32 }),
  noShowFee: decimal("noShowFee", { precision: 12, scale: 2 }).notNull().default("0"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
export type PrivateAppointment = typeof privateAppointments.$inferSelect;

export const privateTrips = mysqlTable("privateTrips", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  clientId: int("clientId").notNull(),
  appointmentId: int("appointmentId"),
  quoteId: int("quoteId"),
  status: varchar("status", { length: 40 }).notNull().default("AGENDADA"),
  clientNameSnapshot: varchar("clientNameSnapshot", { length: 160 }).notNull(),
  clientPhoneSnapshot: varchar("clientPhoneSnapshot", { length: 32 }),
  pickupAddress: text("pickupAddress").notNull(),
  destinationAddress: text("destinationAddress").notNull(),
  ...
  cancellationReason: text("cancellationReason"),
  estimatedDistanceKm: decimal("estimatedDistanceKm", { precision: 12, scale: 3 }).notNull().default("0"),
  actualDistanceKm: decimal("actualDistanceKm", { precision: 12, scale: 3 }),
  estimatedCost: decimal("estimatedCost", { precision: 12, scale: 2 }).notNull().default("0"),
  combinedAmount: decimal("combinedAmount", { precision: 12, scale: 2 }).notNull().default("0"),
  additionalAmount: decimal("additionalAmount", { precision: 12, scale: 2 }).notNull().default("0"),
  discountAmount: decimal("discountAmount", { precision: 12, scale: 2 }).notNull().default("0"),
  finalAmount: decimal("finalAmount", { precision: 12, scale: 2 }).notNull().default("0"),
  paymentStatus: varchar("paymentStatus", { length: 24 }).notNull().default("PENDENTE"),
  paidAmount: decimal("paidAmount", { precision: 12, scale: 2 }).notNull().default("0"),
  remainingAmount: decimal("remainingAmount", { precision: 12, scale: 2 }).notNull().default("0"),
  incomePostedAt: timestamp("incomePostedAt"),
  incomeDate: varchar("incomeDate", { length: 10 }),
  incomeReference: varchar("incomeReference", { length: 96 }),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
export type PrivateTrip = typeof privateTrips.$inferSelect;

export const privateTripStops = mysqlTable("privateTripStops", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  tripId: int("tripId"),
  appointmentId: int("appointmentId"),
...
export type PrivateTripStop = typeof privateTripStops.$inferSelect;

export const privatePayments = mysqlTable("privatePayments", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  tripId: int("tripId").notNull(),
  amount: decimal("amount", { precision: 12, scale: 2 }).notNull(),
  paymentMethod: varchar("paymentMethod", { length: 32 }).notNull().default("PIX"),
  paidAt: timestamp("paidAt").notNull().defaultNow(),
  notes: text("notes"),
  reversedAt: timestamp("reversedAt"),
  reversalReason: text("reversalReason"),
  incomeEarningId: int("incomeEarningId"),
  incomePostedAt: timestamp("incomePostedAt"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
});
export type PrivatePayment = typeof privatePayments.$inferSelect;

export const privateReceipts = mysqlTable("privateReceipts", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  tripId: int("tripId").notNull(),
  paymentId: int("paymentId"),
  receiptCode: varchar("receiptCode", { length: 24 }).notNull().unique(),
  publicToken: varchar("publicToken", { length: 96 }).notNull().unique(),
  publicLinkEnabled: int("publicLinkEnabled").notNull().default(1),
...
export type PrivateReceipt = typeof privateReceipts.$inferSelect;

export const privateEvents = mysqlTable("privateEvents", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
...
export const h2AdsWorkerCommands = mysqlTable("h2ads_worker_commands", {
  ...
  workerId: int("workerId").notNull(),
  instanceId: int("instanceId").notNull(),
  command: mysqlEnum("command", ["prepare_browser", "launch_browser", "close_browser"]).notNull(),
