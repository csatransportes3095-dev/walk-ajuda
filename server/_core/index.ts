...
async function startServer() {
  ...
  app.get("/api/zoho-test-session", async (req, res) => {
    try {
      ...
      console.log('[ZohoTestSession] 4. Sessão recuperada:', retrieved ? 'SIM' : 'NÁƒO');
