...
async function generateReceiptPdf(data: {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.fillColor('#15803d').fontSize(12).font('Helvetica-Bold').text(`NÁ‚Âº do Recibo: ${data.receiptNumber}`, 60, recY + 10);
    doc.moveDown(1.5);
    ...
    rows.push(['Próximo Vencimento:', data.nextDueDate || '—']);
    rows.push(['Confirmado por:', data.confirmedBy || '—']);
    let y = doc.y;
...
// Seg–Sáb = 20 parcelas | Seg–Dom = 25 parcelas | custom = definido pelo admin
...
export const loanRouter = router({
        ...
        await transporter.sendMail({
          ...
          html: `<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;">
            ...
            <div style="background:#f8fafc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0;">
              ...
              <p style="color:#6b7280;font-size:12px;">CSA Empréstimos SP — Atendimento ao cliente</p>
            </div>
          </div>`,
        });
        sentTo = clientEmail;
  ...
  confirmInstallmentPayment: adminProcedure.input(z.object({
    ...
    if (inst.length) {
      ...
      if (parseInt(pending[0].cnt) === 0) {
        // Todas as parcelas pagas ââ€ ' empréstimo pago
        await db.execute(drizzleSql`UPDATE loans SET status='pago', paidAt=NOW(), paidBy=${paidBy} WHERE id=${loanId}`);
      } else {
        // Ainda há parcelas pendentes ââ€ ' verificar se há alguma aguardando análise
        ...
        if (parseInt(awaitingProof[0].cnt) > 0) {
          // Ainda tem comprovante aguardando ââ€ ' mantém aguardando_pagamento
          await db.execute(drizzleSql`UPDATE loans SET status='aguardando_pagamento' WHERE id=${loanId}`);
        } else {
          // Nenhum comprovante pendente ââ€ ' volta para ativo/aprovado
  ...
  // ââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Â
  // LADO DO CLIENTE — via token da planilha (publicProcedure)
  // ââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Âââ€¢Â
  ...
  // Simulação de parcelas (preview antes de confirmar) — não cria no banco
  simulateLoan: publicProcedure.input(z.object({
    ...
    // Não expor taxa ao cliente — retorna apenas o resultado do cálculo
    return {
  ...
  // Busca configuração de taxa de atraso (pública — usada pelo cliente para exibir regras)
  ...
  calcLateFee: publicProcedure.input(z.object({
    ...
    if (nowHour >= 18 && nowHour < 20) {
      ...
      // Passou da meia-noite — 100% da parcela
  ...
  // ââ€â‚¬ââ€â‚¬ ANÁLISE FINANCEIRA (admin) ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬ââ€â‚¬
  ...
  payInterestOnly: adminProcedure.input(z.object({
    ...
    try {
      ...
      await createFinancialSale({
        ...
        productOption: `Parcela #${inst.installmentNumber} — Dívida rolada`,
  ...
  generateLoanStatement: adminProcedure.input(z.object({
    ...
    const profileEmoji: Record<string, string> = { bronze: 'Á°Å¸Â¥â€°', prata: 'âÂ­Â', ouro: 'Á°Å¸Â¥â€¡', diamante: 'Á°Å¸'Å½' };
    ...
    const installmentsRows = installments.map((inst: any) => {
      ...
      const pillLabel: Record<string, string> = { pago: 'âÅ“" Pago', pendente: 'âÂÂ³ Pendente', atrasado: 'âÅ¡Â  Atrasado', em_analise: 'Á°Å¸â€Â Em Análise', cancelado: 'Cancelado' };
      const pStyle = pillColor[statusKey] || pillColor.pendente;
      const pLabel = pillLabel[statusKey] || inst.status;
      const paidAtStr = inst.paidAt ? fmtDate(inst.paidAt.toString().slice(0, 10)) : '—';
      return `<tr>
    ...
    const upgradeSection = nextProfile ? `
      <div style="background:linear-gradient(135deg,#fffbeb,#fef3c7);border:1.5px solid #fcd34d;border-radius:10px;padding:16px 20px;margin-bottom:20px;">
        <table width="100%"><tr><td width="36" style="vertical-align:top;font-size:26px;">âÂ­Â</td><td>
          ...
          <div style="display:flex;align-items:center;gap:8px;">
            ...
            <span style="color:#d97706;font-size:14px;">ââ€ '</span>
            <span style="background:#fef3c7;color:#92400e;padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;border:1px solid #fcd34d;">${profileEmoji[nextProfile.slug] || 'Á°Å¸Â¥â€¡'} ${nextProfile.name}</span>
            <span style="font-size:10px;color:#16a34a;font-weight:600;">ââ€ ' Limite até ${fmtBRL(parseFloat(nextProfile.creditLimit))} Á‚Â· Juros a partir de ${nextProfile.interestRate}%</span>
          </div>
        </td></tr></table>
      </div>
      ...
      <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:8px;padding:14px 18px;margin-bottom:20px;">
        <p style="font-size:12px;font-weight:700;color:#15803d;margin:0 0 4px;">Á°Å¸Ââ€  Você está no nível máximo!</p>
...
<div class="page">
  <div class="hdr">
    ...
    <div style="text-align:right;"><div style="color:#fff;font-size:13px;font-weight:600;background:rgba(245,158,11,.15);border:1px solid rgba(245,158,11,.3);padding:4px 12px;border-radius:20px;">Á°Å¸"â€ž EXTRATO DE EMPRÉSTIMO</div><div style="color:#64748b;font-size:10px;margin-top:5px;">Emitido em: ${emittedAt}</div></div>
  </div>
  <div class="body">
    <div class="sec">Á°Å¸'Â¤ Dados do Cliente</div>
    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:16px 20px;margin-bottom:20px;display:flex;align-items:center;gap:16px;">
      ...
      <div style="flex:1;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:5px;">
          ${loan.clientPhone ? `<span style="font-size:11px;color:#475569;">Á°Å¸"Â± ${loan.clientPhone}</span>` : ''}
          ${cpfFmt !== 'Não informado' ? `<span style="font-size:11px;color:#475569;">Á°Å¸ÂªÂª CPF: ${cpfFmt}</span>` : ''}
          ${loan.clientEmail ? `<span style="font-size:11px;color:#475569;">Á°Å¸"Â§ ${loan.clientEmail}</span>` : ''}
        </div>
      </div>
    ...
    <div class="sec">Á°Å¸'Â° Resumo Financeiro</div>
    ...
    <div class="sec">Á°Å¸"â€¹ Detalhes do Empréstimo</div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:20px;">
      <div style="display:flex;justify-content:space-between;align-items:center;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:8px 12px;"><span style="font-size:10px;color:#64748b;">NÁ‚Âº do Empréstimo</span><span style="font-size:11px;font-weight:700;">#EMP-${String(input.loanId).padStart(4,'0')}</span></div>
      ...
      ${loan.notes ? `<div style="display:flex;justify-content:space-between;align-items:center;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:8px 12px;"><span style="font-size:10px;color:#64748b;">ObservaçÁµes</span><span style="font-size:11px;font-weight:700;">${loan.notes}</span></div>` : ''}
    </div>
    <div class="sec">Á°Å¸"â€¦ Histórico de Parcelas</div>
    <table class="inst">
    ...
    <div class="sec">Á°Å¸Å¡â‚¬ Seu Perfil &amp; Próximo Nível</div>
    ${upgradeSection}
  </div>
  <div class="footer">
    <div><p style="font-size:9px;color:#94a3b8;">CSA Empréstimos SP Á‚Â· h2colombiano.com Á‚Â· h2@h2colombiano.com</p><p style="font-size:9px;color:#94a3b8;margin-top:3px;">Documento gerado automaticamente. Válido como comprovante de situação do empréstimo.</p></div>
