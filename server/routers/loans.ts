...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Helper: obter data de hoje em UTC-3 (Brasil) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
async function generateReceiptPdf(data: {
  ...
  isInterestOnly?: boolean; // true = recibo de juros (rolagem de dÃƒÂ­vida)
}): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc.fillColor('#15803d').fontSize(12).font('Helvetica-Bold').text(`NÃ‚Âº do Recibo: ${data.receiptNumber}`, 60, recY + 10);
    doc.moveDown(1.5);
    ...
    const rows: string[][] = [
      ...
      ['CPF:', data.clientCpf || 'NÃƒÂ£o informado'],
    ...
    if (data.isInterestOnly) {
      ...
      rows.push(['Tipo:', 'Pagamento de Juros (DÃƒÂ­vida Rolada)']);
    ...
    rows.push(['PrÃƒÂ³ximo Vencimento:', data.nextDueDate || 'Ã¢â‚¬â€']);
    rows.push(['Confirmado por:', data.confirmedBy || 'Ã¢â‚¬â€']);
    let y = doc.y;
    ...
    doc.fillColor('#94a3b8').fontSize(8).font('Helvetica')
      .text('Este recibo ÃƒÂ© um comprovante de pagamento emitido pela H2 COLOMBIANO.', 50, footerY + 10, { align: 'center', width: doc.page.width - 100 })
      .text('Guarde este documento para sua seguranÃƒÂ§a.', 50, footerY + 22, { align: 'center', width: doc.page.width - 100 });
    doc.end();
  });
}

// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Helper: converter PDF de recibo para JPG Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
async function generateReceiptJpg(pdfBuffer: Buffer): Promise<Buffer> {
  ...
  try {
    ...
    // pdftoppm converte PDF para PPM (formato intermediÃƒÂ¡rio), depois sharp converte para JPG
    execSync(`pdftoppm -r 200 -jpeg -jpegopt quality=95 "${pdfPath}" "${jpgBase}"`, { timeout: 15000 });
    // Pegar o primeiro arquivo gerado (pÃƒÂ¡gina 1)
    ...
    if (!files.length) {
      ...
      if (!ppmFiles.length) throw new Error('pdftoppm nÃƒÂ£o gerou arquivo de saÃƒÂ­da');
      ppmFiles.sort();
...
async function sendReceiptEmail(to: string, clientName: string, receiptNumber: string, installmentNumber: number, pdfBuffer: Buffer): Promise<void> {
  ...
  await transporter.sendMail({
    ...
    to,
    subject: `Recibo de Pagamento Ã¢â‚¬â€ Parcela #${installmentNumber} | ${receiptNumber}`,
    html: `<div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;"><div style="background:#0f172a;padding:24px;border-radius:8px 8px 0 0;"><h2 style="color:#22c55e;margin:0;">H2 COLOMBIANO</h2><p style="color:#94a3b8;margin:4px 0 0;">Recibo de Pagamento</p></div><div style="background:#f8fafc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0;"><p style="color:#0f172a;">OlÃƒÂ¡, <strong>${clientName}</strong>!</p><p style="color:#374151;">Segue em anexo o recibo da <strong>Parcela #${installmentNumber}</strong>.</p><p style="color:#374151;">NÃƒÂºmero do recibo: <strong>${receiptNumber}</strong></p><hr style="border:none;border-top:1px solid #e2e8f0;margin:16px 0;"><p style="color:#6b7280;font-size:12px;">Guarde este recibo para sua seguranÃƒÂ§a.</p></div></div>`,
...
// AvanÃƒÂ§a para o prÃƒÂ³ximo dia ÃƒÂºtil conforme workDays ("seg_sab" = 0=dom excluÃƒÂ­do, "seg_dom" = todos)
...
// NÃƒÂºmero fixo de parcelas diÃƒÂ¡rias:
// SegÃ¢â‚¬â€œSÃƒÂ¡b = 20 parcelas | SegÃ¢â‚¬â€œDom = 25 parcelas | custom = definido pelo admin
...
// Calcula simulaÃƒÂ§ÃƒÂ£o de parcelas sem criar no banco (usado pelo frontend para preview)
...
export const loanRouter = router({
  ...
  // LADO DO ADMIN Ã¢â‚¬â€ adminProcedure
  // Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â

  // Ã¢â€â‚¬Ã¢â€â‚¬ BUSCA CLIENTE NO SISTEMA PRINCIPAL Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ PIX CONFIG Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ PERFIS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  syncProfile: adminProcedure.input(z.object({
    ...
    if (!profiles.length) throw new Error("Perfil nÃƒÂ£o encontrado");
    const p = profiles[0];
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ CLIENTES (admin) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ EMPRÃƒâ€°STIMOS (admin) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  listLoans: adminProcedure.input(z.object({
    ...
    // Busca parcelas que vencem hoje para cada emprÃƒÂ©stimo aprovado
    ...
    // Busca emprÃƒÂ©stimos que tÃƒÂªm QUALQUER parcela pendente com vencimento anterior a hoje
    ...
    if (input?.status && input.status !== 'todos') {
      if (input.status === 'ativos') {
        ...
        // Inclui emprÃƒÂ©stimos com status aguardando_pagamento OU aprovado com parcela vencendo hoje
        result = result.filter((r: any) => r.status === 'aguardando_pagamento' || r.hasInstallmentDueToday);
      } else if (input.status === 'em_analise') {
        // EmprÃƒÂ©stimos que tÃƒÂªm pelo menos uma parcela em anÃƒÂ¡lise (comprovante enviado pelo cliente)
        result = result.filter((r: any) => Number(r.pendingProofs) > 0);
      } else if (input.status === 'pago_hoje') {
        // EmprÃƒÂ©stimos com pelo menos uma parcela paga hoje (convertendo paidAt para BRT)
  ...
  sendRejectionNotice: adminProcedure.input(z.object({
    ...
    const db = await getDb() as any;
    // Buscar dados do emprÃƒÂ©stimo e cliente
    ...
    `);
    if (!loanRows.length) throw new TRPCError({ code: 'NOT_FOUND', message: 'EmprÃƒÂ©stimo nÃƒÂ£o encontrado' });
    ...
    if (clientEmail) {
      try {
        ...
        await transporter.sendMail({
          from: '"CSA EmprÃƒÂ©stimos SP" <h2@h2colombiano.com>',
          to: clientEmail,
          subject: `AtualizaÃƒÂ§ÃƒÂ£o sobre sua solicitaÃƒÂ§ÃƒÂ£o de emprÃƒÂ©stimo Ã¢â‚¬â€ CSA EmprÃƒÂ©stimos SP`,
          html: `<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;">
            <div style="background:#0f172a;padding:24px;border-radius:8px 8px 0 0;">
              <h2 style="color:#ef4444;margin:0;">CSA EmprÃƒÂ©stimos SP</h2>
              <p style="color:#94a3b8;margin:4px 0 0;">Resultado da AnÃƒÂ¡lise de CrÃƒÂ©dito</p>
            </div>
            <div style="background:#f8fafc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0;">
              <p style="color:#0f172a;">OlÃƒÂ¡, <strong>${loan.clientName}</strong>!</p>
              <p style="color:#374151;">Informamos que sua solicitaÃƒÂ§ÃƒÂ£o de emprÃƒÂ©stimo no valor de <strong>${amountFmt}</strong> foi <strong style="color:#ef4444;">reprovada</strong>.</p>
              ...
              <p style="color:#374151;">Em caso de dÃƒÂºvidas, entre em contato conosco pelo WhatsApp.</p>
              <hr style="border:none;border-top:1px solid #e2e8f0;margin:16px 0;">
              <p style="color:#6b7280;font-size:12px;">CSA EmprÃƒÂ©stimos SP Ã¢â‚¬â€ Atendimento ao cliente</p>
            </div>
          </div>`,
        });
        sentTo = clientEmail;
    ...
    const waMsg = `OlÃƒÂ¡ ${loan.clientName}! Infelizmente sua solicitaÃƒÂ§ÃƒÂ£o de emprÃƒÂ©stimo foi reprovada.\n\nMotivo: ${input.reason}\n\nEm caso de dÃƒÂºvidas, entre em contato conosco.`;
  ...
  confirmInstallmentPayment: adminProcedure.input(z.object({
    ...
    if (inst.length) {
      ...
      if (parseInt(pending[0].cnt) === 0) {
        // Todas as parcelas pagas Ã¢â€ â€™ emprÃƒÂ©stimo pago
        await db.execute(drizzleSql`UPDATE loans SET status='pago', paidAt=NOW(), paidBy=${paidBy} WHERE id=${loanId}`);
      } else {
        // Ainda hÃƒÂ¡ parcelas pendentes Ã¢â€ â€™ verificar se hÃƒÂ¡ alguma aguardando anÃƒÂ¡lise
        ...
        if (parseInt(awaitingProof[0].cnt) > 0) {
          // Ainda tem comprovante aguardando Ã¢â€ â€™ mantÃƒÂ©m aguardando_pagamento
          await db.execute(drizzleSql`UPDATE loans SET status='aguardando_pagamento' WHERE id=${loanId}`);
        } else {
          // Nenhum comprovante pendente Ã¢â€ â€™ volta para ativo/aprovado
  ...
  // Desfaz pagamento confirmado: volta para pendente, MANTÃƒâ€°M comprovante para consulta
  undoInstallmentPayment: adminProcedure.input(z.object({
    ...
    const loanId = inst[0].loanId;
    // Volta para pendente mas MANTÃƒâ€°M proofUrl e proofSentAt para consulta futura
    ...
    // Se o emprÃƒÂ©stimo estava marcado como pago, volta para aprovado
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ DASHBOARD (admin) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  getDashboard: adminProcedure.query(async () => {
    const db = await getDb() as any;
    // Usar fuso horÃƒÂ¡rio de SÃƒÂ£o Paulo (GMT-3) para calcular "hoje"
    const today = getBrazilToday();

    // Totais gerais dos emprÃƒÂ©stimos
    ...
    // Total previsto = soma de TODAS as parcelas de emprÃƒÂ©stimos ativos (capital + juros)
    ...
    // Total recebido = soma das parcelas individualmente pagas (independente do status do emprÃƒÂ©stimo)
    ...
    // Juros recebidos: proporcional ao valor pago em relaÃƒÂ§ÃƒÂ£o ao total do emprÃƒÂ©stimo
    ...
    // Lucro Total Previsto = interestAmount total de todos os emprÃƒÂ©stimos ativos
    ...
    // Capital Recuperado = do total recebido, quanto ÃƒÂ© capital (nÃƒÂ£o juros)
    ...
    // GrÃƒÂ¡fico mensal: dois datasets separados
    // 1) Emprestado por mÃƒÂªs de criaÃƒÂ§ÃƒÂ£o do emprÃƒÂ©stimo
    ...
    `);
    // 2) Recebido por mÃƒÂªs em que a parcela foi efetivamente paga
    const receivedByMonth = await qRows(db, drizzleSql`
      ...
      GROUP BY month ORDER BY month ASC
    `);
    // Mescla os dois datasets pelo mÃƒÂªs
  ...
  // Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
  // LADO DO CLIENTE Ã¢â‚¬â€ via token da planilha (publicProcedure)
  // Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â

  getClientLoanInfo: publicProcedure.input(z.object({ token: z.string() })).query(async ({ input }) => {
    const db = await getDb() as any;
    const token = input.token.trim();
    // Buscar sessÃƒÂ£o da planilha para obter dados do cliente
    ...
    if (!clients.length) {
      // Verificar se jÃƒÂ¡ existe um loanClient com o mesmo CPF ou telefone (evitar duplicidade)
      ...
      if (existingByIdentity.length) {
        ...
        // Criar automaticamente com loanEnabled=1 (padrÃƒÂ£o liberado)
    ...
    `);
    const today = getBrazilToday();
    // Busca emprÃƒÂ©stimos com parcelas pendentes vencidas
  ...
  // SimulaÃƒÂ§ÃƒÂ£o de parcelas (preview antes de confirmar) Ã¢â‚¬â€ nÃƒÂ£o cria no banco
  simulateLoan: publicProcedure.input(z.object({
    ...
    if (!clients.length) throw new TRPCError({ code: "UNAUTHORIZED", message: "EmprÃƒÂ©stimos nÃƒÂ£o habilitados para este cliente" });
    const client = clients[0];
    ...
    // NÃƒÂ£o expor taxa ao cliente Ã¢â‚¬â€ retorna apenas o resultado do cÃƒÂ¡lculo
    return {
  ...
  requestLoan: publicProcedure.input(z.object({
    ...
    if (!client.client_pix_key || !client.client_pix_name || !client.client_pix_bank) {
      throw new TRPCError({ code: "BAD_REQUEST", message: "VocÃƒÂª precisa cadastrar sua chave PIX completa (chave, nome do titular e banco) antes de solicitar um emprÃƒÂ©stimo." });
    }

    // Valida se o tipo de pagamento estÃƒÂ¡ liberado para este cliente
    const allowed = (client.allowedPaymentTypes || "diario").split(",").map((t: string) => t.trim());
    if (!allowed.includes(input.paymentType)) {
      throw new TRPCError({ code: "BAD_REQUEST", message: `Modo de pagamento "${input.paymentType}" nÃƒÂ£o liberado para este cliente` });
    }
  ...
  saveClientPixKey: publicProcedure.input(z.object({
    token: z.string(),
    pixKey: z.string().min(5, "Chave PIX invÃƒÂ¡lida").max(200),
    pixName: z.string().min(2, "Nome do titular obrigatÃƒÂ³rio").max(200),
    pixBank: z.string().min(2, "Nome do banco obrigatÃƒÂ³rio").max(100),
  })).mutation(async ({ input }) => {
    const db = await getDb() as any;
    const token = input.token.trim();
    const clients = await qRows(db, drizzleSql`SELECT * FROM loanClients WHERE spreadsheetToken=${token}`);
  ...
  // Lista todos os clientes com senha no /gastos com status de emprÃƒÂ©stimo habilitado
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ TAXA DE ATRASO E REGRAS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

  // Busca configuraÃƒÂ§ÃƒÂ£o de taxa de atraso (pÃƒÂºblica Ã¢â‚¬â€ usada pelo cliente para exibir regras)
  ...
  // Salva configuraÃƒÂ§ÃƒÂ£o de taxa de atraso (admin)
  ...
  // Toggle taxa de atraso por cliente especÃƒÂ­fico (admin)
  ...
  // Calcula taxa de atraso para uma parcela especÃƒÂ­fica (chamado pelo cliente ao ver parcelas)
  calcLateFee: publicProcedure.input(z.object({
    ...
    // SÃƒÂ³ aplica taxa se a parcela estÃƒÂ¡ pendente/atrasada e ÃƒÂ© do dia de hoje
    const today = getBrazilToday();
    ...
    if (nowHour >= 18 && nowHour < 20) {
      ...
      breakdown = [`ApÃƒÂ³s 18h: +R$ ${lateFee.toFixed(2)}`];
    } else if (nowHour >= 20 && nowHour < 24) {
      lateFee = parseFloat(cfg.fee_after_18h) + parseFloat(cfg.fee_after_20h);
      breakdown = [`ApÃƒÂ³s 18h: +R$ ${parseFloat(cfg.fee_after_18h).toFixed(2)}`, `ApÃƒÂ³s 20h: +R$ ${parseFloat(cfg.fee_after_20h).toFixed(2)}`];
    } else if (nowHour >= 0 && installment.dueDate < today) {
      // Passou da meia-noite Ã¢â‚¬â€ 100% da parcela
      const pct = parseFloat(cfg.fee_after_midnight_pct) / 100;
      lateFee = Math.round(amount * pct * 100) / 100;
      breakdown = [`ApÃƒÂ³s 23:59: +${cfg.fee_after_midnight_pct}% da parcela (R$ ${lateFee.toFixed(2)})`];
    }

    return { lateFee, totalWithFee: amount + lateFee, breakdown };
  }),

  // Ativar/desativar emprÃƒÂ©stimo por telefone (cria loanClient se nÃƒÂ£o existir)
  toggleLoanByPhone: adminProcedure.input(z.object({
    ...
    if (existing.length) {
      // Atualiza todos os registros com esse telefone (evita inconsistÃƒÂªncia em duplicatas)
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ ANÃƒÂLISE FINANCEIRA (admin) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  getFinancialAnalysis: adminProcedure.input(z.object({
    ...
    // Montar condiÃƒÂ§ÃƒÂ£o de data para parcelas
    ...
    // 1. JÃƒÂ¡ recebi (parcelas pagas no perÃƒÂ­odo)
    ...
    // 2. Vou receber (parcelas pendentes com vencimento no perÃƒÂ­odo)
    ...
    // 3. Quanto vou ganhar de juros (proporcional ao perÃƒÂ­odo)
    ...
    // 4. Juros jÃƒÂ¡ recebidos no perÃƒÂ­odo
    ...
    // 5. Perdas: emprestado em emprÃƒÂ©stimos cancelados/reprovados no perÃƒÂ­odo
    ...
    // 6. InadimplÃƒÂªncia: parcelas atrasadas (vencidas e nÃƒÂ£o pagas) no perÃƒÂ­odo
    const today = getBrazilToday();
    ...
    // 7. Timeline: parcelas a receber por dia (para grÃƒÂ¡fico)
    ...
    // 8. PrÃƒÂ³ximas parcelas a vencer (para tabela "quando vou receber")
  ...
  // Corrige parcelas pendentes que caem no domingo para emprÃƒÂ©stimos com workDays=seg_sab
  fixSundayInstallments: adminProcedure.mutation(async () => {
    const db = await getDb() as any;
    // Busca parcelas pendentes em domingo de emprÃƒÂ©stimos seg_sab
    ...
    // Atualiza o dueDate do emprÃƒÂ©stimo (data da ÃƒÂºltima parcela)
  ...
  // Edita um emprÃƒÂ©stimo ativo: recalcula juros, total e parcelas pendentes
  ...
  payInterestOnly: adminProcedure.input(z.object({
    loanId: z.number(),
    installmentId: z.number(), // ID da parcela vencida especÃƒÂ­fica
  })).mutation(async ({ ctx, input }) => {
    const db = await getDb() as any;
    ...
    const loan = loans[0];
    if (!loan.interestOnlyEnabled) throw new TRPCError({ code: "BAD_REQUEST", message: "FunÃƒÂ§ÃƒÂ£o de pagamento sÃƒÂ³ de juros nÃƒÂ£o estÃƒÂ¡ ativada neste emprÃƒÂ©stimo" });
    if (["pago", "cancelado", "reprovado"].includes(loan.status)) throw new TRPCError({ code: "BAD_REQUEST", message: "EmprÃƒÂ©stimo jÃƒÂ¡ encerrado" });

    // Busca a parcela especÃƒÂ­fica
    const today = getBrazilToday();
    ...
    if (!instRows.length) throw new TRPCError({ code: "NOT_FOUND", message: "Parcela nÃƒÂ£o encontrada" });
    const inst = instRows[0];
    if (inst.status !== 'pendente') throw new TRPCError({ code: "BAD_REQUEST", message: "Parcela nÃƒÂ£o estÃƒÂ¡ pendente" });
    if (inst.dueDate >= today) throw new TRPCError({ code: "BAD_REQUEST", message: "Parcela ainda nÃƒÂ£o venceu" });
    ...
    // Principal desta parcela = valor total do emprÃƒÂ©stimo / nÃƒÂºmero de parcelas
    ...
    // Busca a ÃƒÂºltima data de vencimento existente entre as parcelas pendentes (excluindo a atual)
    // para criar a nova parcela DEPOIS da ÃƒÂºltima
    ...
    // Novo amount da parcela rolada = principal + juros novos (sem a taxa, que jÃƒÂ¡ foi cobrada)
    const newInstAmount = Math.round((principalPerInstallment + interestOnPrincipal) * 100) / 100;

    // PrÃƒÂ³ximo nÃƒÂºmero de parcela (apÃƒÂ³s o maior existente)
    ...
    // 2. Cria nova parcela com principal + juros novos (dÃƒÂ­vida rolada), vencendo apÃƒÂ³s a ÃƒÂºltima
    await db.execute(drizzleSql`
    ...
    // 3. Atualiza vencimento do emprÃƒÂ©stimo para a nova data e incrementa contador
    await db.execute(drizzleSql`
    ...
    try {
      ...
      await createFinancialSale({
        ...
        productName: `Juros EmprÃƒÂ©stimo #EMP-${String(input.loanId).padStart(4,'0')}`,
        productOption: `Parcela #${inst.installmentNumber} Ã¢â‚¬â€ DÃƒÂ­vida rolada`,
  ...
  undoInterestOnly: adminProcedure.input(z.object({
    ...
    if (!instRows.length) throw new TRPCError({ code: 'NOT_FOUND', message: 'Parcela nÃƒÂ£o encontrada' });
    const inst = instRows[0];
    if (inst.status !== 'pago_juros') throw new TRPCError({ code: 'BAD_REQUEST', message: 'Parcela nÃƒÂ£o estÃƒÂ¡ com status pago_juros' });
    ...
    `);
    // 3. Deleta a parcela rolada (rolled_from_interest_only) criada apÃƒÂ³s esta
    // Busca a parcela com nÃƒÂºmero maior que a atual e notes contendo rolled_from_interest_only
    await db.execute(drizzleSql`
    ...
    `);
    // 4. Restaura o vencimento do emprÃƒÂ©stimo para a ÃƒÂºltima parcela pendente restante
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ COMPROVANTES DE PAGAMENTO (ADMIN) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Buscar comprovantes de um emprÃƒÂ©stimo (batch por loanId)
  ...
  // Adicionar comprovante a pagamento jÃƒÂ¡ confirmado sem arquivo
  ...
  replaceInstallmentProof: adminProcedure.input(z.object({
    ...
    const inst = instRows[0];
    const existing = await qRows(db, drizzleSql`SELECT * FROM installmentProofs WHERE installmentId=${input.installmentId} ORDER BY id DESC LIMIT 1`);
    if (!existing.length) throw new TRPCError({ code: 'NOT_FOUND', message: 'Comprovante nÃƒÂ£o encontrado' });
  ...
  // Excluir comprovante (nÃƒÂ£o desfaz pagamento)
  ...
  // HistÃƒÂ³rico de comprovantes com filtros
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ RECIBO DE PAGAMENTO Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  generateReceipt: adminProcedure.input(z.object({
    ...
    try {
      ...
      // Garantir que amount ÃƒÂ© nÃƒÂºmero
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ EXTRATO COMPLETO DO EMPRÃƒâ€°STIMO Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  generateLoanStatement: adminProcedure.input(z.object({
    loanId: z.number(),
  })).mutation(async ({ input }) => {
    console.log('[generateLoanStatement] START loanId:', input.loanId);
    const db = await getDb() as any;
    // Buscar dados do emprÃƒÂ©stimo + cliente
    ...
    `);
    // Buscar perfil atual e prÃƒÂ³ximo
    ...
    const cpfFmt = rawCpf.length === 11 ? `${rawCpf.slice(0,3)}.${rawCpf.slice(3,6)}.${rawCpf.slice(6,9)}-${rawCpf.slice(9)}` : (rawCpf || 'NÃƒÂ£o informado');
    const fmtBRL = (v: number) => v.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
    const fmtDate = (d: string) => d ? new Date(d + 'T12:00:00Z').toLocaleDateString('pt-BR') : 'Ã¢â‚¬â€';
    const statusLabel: Record<string, string> = { aprovado: 'Aprovado', pendente: 'Aguardando AprovaÃƒÂ§ÃƒÂ£o', reprovado: 'Reprovado', cancelado: 'Cancelado', pago: 'Pago' };
    const payTypeLabel: Record<string, string> = { diario: 'DiÃƒÂ¡rio', semanal: 'Semanal', quinzenal: 'Quinzenal', mensal: 'Mensal' };
    const profileEmoji: Record<string, string> = { bronze: 'Ã°Å¸Â¥â€°', prata: 'Ã¢Â­Â', ouro: 'Ã°Å¸Â¥â€¡', diamante: 'Ã°Å¸â€™Å½' };
    ...
    const installmentsRows = installments.map((inst: any) => {
      ...
      const pillLabel: Record<string, string> = { pago: 'Ã¢Å“â€œ Pago', pendente: 'Ã¢ÂÂ³ Pendente', atrasado: 'Ã¢Å¡Â  Atrasado', em_analise: 'Ã°Å¸â€Â Em AnÃƒÂ¡lise', cancelado: 'Cancelado' };
      const pStyle = pillColor[statusKey] || pillColor.pendente;
      const pLabel = pillLabel[statusKey] || inst.status;
      const paidAtStr = inst.paidAt ? fmtDate(inst.paidAt.toString().slice(0, 10)) : 'Ã¢â‚¬â€';
      return `<tr>
    ...
    const upgradeSection = nextProfile ? `
      <div style="background:linear-gradient(135deg,#fffbeb,#fef3c7);border:1.5px solid #fcd34d;border-radius:10px;padding:16px 20px;margin-bottom:20px;">
        <table width="100%"><tr><td width="36" style="vertical-align:top;font-size:26px;">Ã¢Â­Â</td><td>
          <p style="font-size:13px;font-weight:700;color:#92400e;margin:0 0 6px;">ParabÃƒÂ©ns! VocÃƒÂª estÃƒÂ¡ no caminho certo, ${loan.clientName.split(' ')[0]}!</p>
          <p style="font-size:11px;color:#78350f;line-height:1.6;margin:0 0 10px;">VocÃƒÂª estÃƒÂ¡ no perfil <strong>${currentProfile?.name || loan.profileSlug}</strong> com limite de <strong>${fmtBRL(parseFloat(loan.clientCreditLimit || 0))}</strong>. Mantendo seus pagamentos em dia, vocÃƒÂª sobe de categoria <strong>automaticamente</strong> e ganha acesso a limites maiores e taxas menores!</p>
          <div style="display:flex;align-items:center;gap:8px;">
            <span style="background:#e2e8f0;color:#475569;padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;">${profileEmoji[loan.profileSlug] || 'Ã¢Â­Â'} ${currentProfile?.name || loan.profileSlug}</span>
            <span style="color:#d97706;font-size:14px;">Ã¢â€ â€™</span>
            <span style="background:#fef3c7;color:#92400e;padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;border:1px solid #fcd34d;">${profileEmoji[nextProfile.slug] || 'Ã°Å¸Â¥â€¡'} ${nextProfile.name}</span>
            <span style="font-size:10px;color:#16a34a;font-weight:600;">Ã¢â€ â€˜ Limite atÃƒÂ© ${fmtBRL(parseFloat(nextProfile.creditLimit))} Ã‚Â· Juros a partir de ${nextProfile.interestRate}%</span>
          </div>
        </td></tr></table>
      </div>
      <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:8px;padding:14px 18px;margin-bottom:20px;">
        <p style="font-size:11px;font-weight:700;color:#15803d;margin:0 0 8px;">Ã¢Å“â€¦ Como subir de categoria automaticamente:</p>
        <ul style="font-size:10px;color:#166534;line-height:1.8;padding-left:16px;margin:0;">
          ...
          <li>Mantenha bom histÃƒÂ³rico por pelo menos 2 emprÃƒÂ©stimos consecutivos</li>
          <li>NÃƒÂ£o tenha parcelas em aberto vencidas</li>
          <li>A promoÃƒÂ§ÃƒÂ£o de categoria ÃƒÂ© feita automaticamente pelo sistema</li>
        </ul>
      </div>` : `
      <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:8px;padding:14px 18px;margin-bottom:20px;">
        <p style="font-size:12px;font-weight:700;color:#15803d;margin:0 0 4px;">Ã°Å¸Ââ€  VocÃƒÂª estÃƒÂ¡ no nÃƒÂ­vel mÃƒÂ¡ximo!</p>
        <p style="font-size:11px;color:#166534;margin:0;">Continue mantendo seus pagamentos em dia para preservar seus benefÃƒÂ­cios exclusivos.</p>
      </div>`;
...
<div class="page">
  <div class="hdr">
    <div><h1 style="color:#f59e0b;font-size:20px;font-weight:800;margin:0;">CSA EMPRÃƒâ€°STIMOS SP</h1><p style="color:#94a3b8;font-size:11px;margin:3px 0 0;">h2colombiano.com</p></div>
    <div style="text-align:right;"><div style="color:#fff;font-size:13px;font-weight:600;background:rgba(245,158,11,.15);border:1px solid rgba(245,158,11,.3);padding:4px 12px;border-radius:20px;">Ã°Å¸â€œâ€ž EXTRATO DE EMPRÃƒâ€°STIMO</div><div style="color:#64748b;font-size:10px;margin-top:5px;">Emitido em: ${emittedAt}</div></div>
  </div>
  <div class="body">
    <div class="sec">Ã°Å¸â€˜Â¤ Dados do Cliente</div>
    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:16px 20px;margin-bottom:20px;display:flex;align-items:center;gap:16px;">
      ...
      <div style="flex:1;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:5px;">
          ${loan.clientPhone ? `<span style="font-size:11px;color:#475569;">Ã°Å¸â€œÂ± ${loan.clientPhone}</span>` : ''}
          ${cpfFmt !== 'NÃƒÂ£o informado' ? `<span style="font-size:11px;color:#475569;">Ã°Å¸ÂªÂª CPF: ${cpfFmt}</span>` : ''}
          ${loan.clientEmail ? `<span style="font-size:11px;color:#475569;">Ã°Å¸â€œÂ§ ${loan.clientEmail}</span>` : ''}
        </div>
      </div>
      <div style="text-align:center;flex-shrink:0;">
        <div style="display:inline-block;padding:4px 14px;border-radius:20px;font-size:12px;font-weight:700;background:#e2e8f0;color:#475569;border:1px solid #cbd5e1;">${profileEmoji[loan.profileSlug] || 'Ã¢Â­Â'} ${(currentProfile?.name || loan.profileSlug).toUpperCase()}</div>
    ...
    <div class="sec">Ã°Å¸â€™Â° Resumo Financeiro</div>
    ...
    <div style="margin-bottom:20px;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;"><span style="font-size:11px;color:#475569;font-weight:500;">Progresso do pagamento</span><strong style="font-size:12px;color:#0f172a;">${progressPct}% concluÃƒÂ­do</strong></div>
    ...
    <div class="sec">Ã°Å¸â€œâ€¹ Detalhes do EmprÃƒÂ©stimo</div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:20px;">
      <div style="display:flex;justify-content:space-between;align-items:center;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:8px 12px;"><span style="font-size:10px;color:#64748b;">NÃ‚Âº do EmprÃƒÂ©stimo</span><span style="font-size:11px;font-weight:700;">#EMP-${String(input.loanId).padStart(4,'0')}</span></div>
      ...
      <div style="display:flex;justify-content:space-between;align-items:center;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:8px 12px;"><span style="font-size:10px;color:#64748b;">Data de LiberaÃƒÂ§ÃƒÂ£o</span><span style="font-size:11px;font-weight:700;">${fmtDate(loan.releaseDate)}</span></div>
      ...
      ${loan.notes ? `<div style="display:flex;justify-content:space-between;align-items:center;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:8px 12px;"><span style="font-size:10px;color:#64748b;">ObservaÃƒÂ§ÃƒÂµes</span><span style="font-size:11px;font-weight:700;">${loan.notes}</span></div>` : ''}
    </div>
    <div class="sec">Ã°Å¸â€œâ€¦ HistÃƒÂ³rico de Parcelas</div>
    <table class="inst">
    ...
    <div class="sec">Ã°Å¸Å¡â‚¬ Seu Perfil &amp; PrÃƒÂ³ximo NÃƒÂ­vel</div>
    ${upgradeSection}
  </div>
  <div class="footer">
    <div><p style="font-size:9px;color:#94a3b8;">CSA EmprÃƒÂ©stimos SP Ã‚Â· h2colombiano.com Ã‚Â· h2@h2colombiano.com</p><p style="font-size:9px;color:#94a3b8;margin-top:3px;">Documento gerado automaticamente. VÃƒÂ¡lido como comprovante de situaÃƒÂ§ÃƒÂ£o do emprÃƒÂ©stimo.</p></div>
    ...
    // Gerar PDF via weasyprint (disponÃƒÂ­vel no servidor)
    ...
    try {
      ...
      if (!fs.existsSync(pdfPath)) {
        throw new TRPCError({ code: 'INTERNAL_SERVER_ERROR', message: 'PDF nÃƒÂ£o foi gerado pelo weasyprint' });
      }
    ...
    const phone = loan.clientPhone ? loan.clientPhone.replace(/\D/g, '') : null;
    const waMsg = `OlÃƒÂ¡ ${loan.clientName}! Segue o extrato completo do seu emprÃƒÂ©stimo #EMP-${String(input.loanId).padStart(4,'0')}.\n\nValor: ${fmtBRL(parseFloat(loan.amount))} | Total c/ juros: ${fmtBRL(totalAmount)}\nPago: ${fmtBRL(totalPaid)} | Saldo: ${fmtBRL(remaining)}\n\nAcesse o PDF: ${url}\n\nEm caso de dÃƒÂºvidas, entre em contato conosco.`;
    const whatsappUrl = phone ? `https://wa.me/55${phone}?text=${encodeURIComponent(waMsg)}` : null;
  ...
  sendLoanStatementByEmail: adminProcedure.input(z.object({
    ...
    const db = await getDb() as any;
    // Buscar e-mail se nÃƒÂ£o fornecido
    ...
    if (!toEmail) throw new TRPCError({ code: 'BAD_REQUEST', message: 'E-mail do cliente nÃƒÂ£o encontrado. Informe o e-mail manualmente.' });
    ...
    await transporter.sendMail({
      from: '"CSA EmprÃƒÂ©stimos SP" <h2@h2colombiano.com>',
      to: toEmail,
      subject: `Extrato do seu EmprÃƒÂ©stimo Ã¢â‚¬â€ ${input.docId} | CSA EmprÃƒÂ©stimos SP`,
      html: `<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;"><div style="background:#0f172a;padding:24px;border-radius:8px 8px 0 0;"><h2 style="color:#f59e0b;margin:0;">CSA EmprÃƒÂ©stimos SP</h2><p style="color:#94a3b8;margin:4px 0 0;">Extrato de EmprÃƒÂ©stimo</p></div><div style="background:#f8fafc;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e2e8f0;"><p style="color:#0f172a;">OlÃƒÂ¡, <strong>${input.clientName}</strong>!</p><p style="color:#374151;">Segue em anexo o extrato completo do seu emprÃƒÂ©stimo <strong>${input.docId}</strong>.</p><p style="color:#374151;">O documento contÃƒÂ©m todas as informaÃƒÂ§ÃƒÂµes do emprÃƒÂ©stimo, histÃƒÂ³rico de parcelas e detalhes do seu perfil de crÃƒÂ©dito.</p><hr style="border:none;border-top:1px solid #e2e8f0;margin:16px 0;"><p style="color:#6b7280;font-size:12px;">CSA EmprÃƒÂ©stimos SP Ã¢â‚¬â€ Atendimento ao cliente</p></div></div>`,
  ...
  // Aplica taxa de atraso prÃƒÂ©-estabelecida a uma parcela (admin)
  applyLateFeeToInstallment: adminProcedure.input(z.object({
    ...
    if (!inst.length) throw new TRPCError({ code: 'NOT_FOUND', message: 'Parcela nÃƒÂ£o encontrada' });
    const current = inst[0];
    if (current.status === 'pago') throw new TRPCError({ code: 'BAD_REQUEST', message: 'Parcela jÃƒÂ¡ estÃƒÂ¡ paga' });
    // Salva o valor original se ainda nÃƒÂ£o foi salvo
  ...
  // Gerar PDF de oferta de emprÃƒÂ©stimo prÃƒÂ©-aprovado e retornar link WhatsApp
  generateLoanOffer: adminProcedure.input(z.object({
    ...
    const { url } = await storagePut(fileKey, pdfBuffer, 'application/pdf');
    const paymentTypeLabel = input.paymentType === 'diario' ? 'DiÃƒÂ¡rio' : input.paymentType === 'semanal' ? 'Semanal' : input.paymentType === 'quinzenal' ? 'Quinzenal' : 'Mensal';
  ...
  // Reagenda parcelas pendentes de um emprÃƒÂ©stimo diÃƒÂ¡rio para novo regime (seg_sab ou seg_dom)
  rescheduleInstallments: adminProcedure.input(z.object({
    ...
    const db = await getDb() as any;
    // Buscar o emprÃƒÂ©stimo
    const loanRows = await qRows(db, drizzleSql`SELECT * FROM loans WHERE id=${input.loanId} LIMIT 1`);
    if (!loanRows.length) throw new TRPCError({ code: 'NOT_FOUND', message: 'EmprÃƒÂ©stimo nÃƒÂ£o encontrado' });
    const loan = loanRows[0];
    if (loan.paymentType !== 'diario') throw new TRPCError({ code: 'BAD_REQUEST', message: 'Reagendamento disponÃƒÂ­vel apenas para emprÃƒÂ©stimos diÃƒÂ¡rios' });
    // Buscar parcelas pendentes (nÃƒÂ£o pagas)
    const pendingRows = await qRows(db, drizzleSql`
      SELECT * FROM loanInstallments
      WHERE loanId=${input.loanId} AND status != 'pago'
      ORDER BY installmentNumber ASC
    `);
    if (!pendingRows.length) throw new TRPCError({ code: 'BAD_REQUEST', message: 'NÃƒÂ£o hÃƒÂ¡ parcelas pendentes para reagendar' });
    // Buscar ÃƒÂºltima parcela paga para usar como base de data
    const lastPaidRows = await qRows(db, drizzleSql`
      SELECT dueDate FROM loanInstallments
      WHERE loanId=${input.loanId} AND status='pago'
      ORDER BY installmentNumber DESC LIMIT 1
    `);
    // Data base: hoje ou data da ÃƒÂºltima parcela paga (o que for mais recente)
    ...
    // Atualizar workDays no emprÃƒÂ©stimo
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ SYNC: Sincronizar clientes de emprÃƒÂ©stimo com senhas ativas do Gastos Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  syncFromGastos: adminProcedure.mutation(async () => {
    ...
    // Inserir todos os clientes do Gastos que ainda nÃƒÂ£o existem no EmprÃƒÂ©stimos
