...
export const spreadsheetRouter = router({
  ...
  // Retornar informaçÁµes do plano para o cliente logado (vencimento da senha)
    ...
    .query(async () => {
      try {
        ...
        for (const client of clients) {
          ...
          // Contagem de acessos: soma de accessCount de todas as sessÁµes do cliente
