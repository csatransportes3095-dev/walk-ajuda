...
// ----- customerUpdate: regra central única, sem política manual e telefone imutável -----
...
// ----- customerPassword: login/gate usa a mesma regra central, sem política antiga -----
...
// ----- schedule backend: central session + central requirements + legacy update disabled -----
...
// ----- atualizarcadastro client: safe return to same schedule + photo compatibility + immutable phone -----
...
// ----- schedule client: create central session, redirect to updater, never render parallel form -----
