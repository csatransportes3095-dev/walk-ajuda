...
// customers.register normaliza com {...input}; logo os campos canônicos adicionados ao
// schema acima seguem juntos para a validação/criação, sem manter um segundo mapa parcial.
...
assertHas(routers, 'const normalizedInput = {');
assertHas(routers, '...input,');
