...
export function StorefrontProductCard({
  ...
  // A opção pode sobrescrever o visual, mas o cadastro do produto é o fallback real.
  // Antes, as cores do produto configuradas no ADM eram ignoradas e o overlay escuro
  // cobria o fundo, fazendo cards ativos parecerem desativados.
