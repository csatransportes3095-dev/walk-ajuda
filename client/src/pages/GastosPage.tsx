...
function goToProfileUpdate(phone: string, returnTo: '/gastos' | '/emprestimo') {
...
export function GastosPage() {
  ...
  useEffect(() => {
    ...
    if (verifyQuery.data?.valid && verifyQuery.data.profileIncomplete) {
      ...
      goToProfileUpdate(verifyQuery.data.clientPhone || '', '/gastos');
      return;
    }
  ...
  if (!isLoggedIn) {
    return <GastosLoginPage onLoginSuccess={handleLoginSuccess} sourceRoute="gastos" />;
  }
