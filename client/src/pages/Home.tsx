...
import { MessageCircle, Zap, Phone, Clock, Users, Upload, FileUp, Ticket, Copy, Check, ImageIcon, AlertTriangle, Camera, Car, Loader2, UserCircle, X, KeyRound, ShoppingCart, Trash2, LogOut, HelpCircle, ChevronDown, CalendarDays } from "lucide-react";
...
export default function Home() {
  ...
  const customerSessionToken = typeof window !== 'undefined' ? localStorage.getItem('cp_token') || '' : '';
  const [showMyData, setShowMyData] = useState(false);
  const myActiveScheduleQuery = trpc.schedule.getMyActive.useQuery(
    { cpToken: customerSessionToken, phone: clientPhoneFromSession },
    {
      enabled: customerSessionToken.length >= 32 && clientPhoneFromSession.length >= 8,
      retry: false,
        ...
        <div className="container pb-4">
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            ...
            {(() => {
              ...
              const isConfirmed = isActive && schedule.status === 'confirmed';
