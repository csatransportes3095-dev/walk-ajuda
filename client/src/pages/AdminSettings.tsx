...
const FONT_OPTIONS = [
  ...
  { value: "Montserrat Bold", label: "�x� Montserrat Bold", desc: "Elegante, forte e impactante" },
  { value: "Poppins Bold", label: "�x� Poppins Bold", desc: "Arredondada, moderna e marcante" },
  // Sans-serif modernas
    ...
    <div className="min-h-screen bg-[#0a0a1a] text-white">
      ...
      <div className="max-w-4xl mx-auto p-4">
          ...
          <div className="space-y-6">
            ...
            <Section title="Botões da Página Inicial">
              ...
              <div className="bg-[#0d0d2b] border border-purple-500/20 rounded-xl p-4 mb-4">
                <p className="text-xs font-bold text-purple-300 mb-3">�x� Botão 1 (ex: FAZER PEDIDO)</p>
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="text-xs text-gray-400 block mb-1">�x Link de Destino (URL ou rota)</label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <select value={form.home_btn1_hover || "scale"} onChange={e => updateField("home_btn1_hover", e.target.value)} style={{ backgroundColor: '#1a1a3e', color: '#ffffff', border: '1px solid rgba(139, 92, 246, 0.3)', borderRadius: '0.5rem', padding: '0.5rem 0.75rem', fontSize: '0.875rem', width: '100%', outline: 'none' }}>
                      <option value="scale">�x� Zoom (aumenta levemente)</option>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 rounded-2xl px-5 py-4" style={{ background: form.home_btn1_color || "#7c3aed", fontFamily: form.home_btn1_font ? `'${form.home_btn1_font}', sans-serif` : undefined }}>
                      <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.2)' }}><span className="text-xl">�x9</span></div>
              ...
              <div className="bg-[#0d0d2b] border border-purple-500/20 rounded-xl p-4">
                <p className="text-xs font-bold text-purple-300 mb-3">�xx� Botão 2 (ex: ACOMPANHAR)</p>
                <div className="space-y-3">
            ...
            <Section title="�xR Botões Rápidos � Hub Central de Acesso">
              <HomeButtonsManager />
            </Section>

            {/*
            BLOCO ANTIGO DE BOT�"ES FIXOS - REMOVIDO
            {/* Botão 3 */}
            <div className="bg-[#0d0d2b] border border-amber-500/20 rounded-xl p-4 space-y-3 mb-4" style={{display: 'none'}}>
                <div className="flex items-center justify-between">
                  <p className="text-xs font-bold text-amber-300">�x�  Botão 3 (ex: SORTEIO)</p>
                  <div
              ...
              <div className="bg-[#0d0d2b] border border-cyan-500/20 rounded-xl p-4 space-y-3 mb-4">
                <div className="flex items-center justify-between">
                  <p className="text-xs font-bold text-cyan-300">�x Botão 4 (ex: NOVIDADES)</p>
                  <div
            ...
            */
            ...
            <Section title="Bloco Serviços Extras">
              ...
              <Field label="Título" k="extras_title" form={form} onChange={updateField} placeholder="�x� Serviços Extras" />
        ...
        {activeTab === "login" && (
          <div className="space-y-6">
            ...
            <Section title="Textos da Tela de Login">
              ...
              <Field label="Título Principal" k="login_title" form={form} onChange={updateField} placeholder="H2 COLOMBIANO" />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select value={newPix.pixType} onChange={e => setNewPix(p => ({ ...p, pixType: e.target.value }))} className="w-full bg-[#1a1a35] border border-white/10 rounded-lg px-3 py-2 text-sm text-white">
                        <option>TELEFONE</option><option>CPF</option><option>EMAIL</option><option>ALEAT�RIA</option><option>CNPJ</option>
                      </select>
                    </div>
                    <div>
        ...
        {activeTab === "photo" && (
          <div className="space-y-6">
            <div className="bg-[#111128] border border-purple-500/20 rounded-xl p-5">
              ...
              <div className="grid grid-cols-1 gap-3">
                {([
                  { value: 'both', label: 'Câmera + Galeria', desc: 'Cliente pode escolher entre tirar foto ou selecionar da galeria (padrão)', icon: '�x��x�️' },
                  { value: 'camera', label: 'Somente Câmera', desc: 'Obriga o cliente a tirar a foto na hora � evita fotos de terceiros', icon: '�x�' },
                  { value: 'gallery', label: 'Somente Galeria', desc: 'Cliente seleciona uma foto já existente no celular', icon: '�x�️' },
                  { value: 'disabled', label: 'Desativado', desc: 'O campo de foto não aparece para o cliente durante o cadastro', icon: '�xa�' },
                ] as const).map(opt => (
                  <button
                    key={opt.value}
                    type="button"
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4">
              <p className="text-yellow-300 text-sm font-semibold mb-1">�a�️ Aviso sobre foto de rosto</p>
        ...
        {activeTab === "security" && (
          <div className="space-y-6">
            <div className="bg-[#111128] border border-purple-500/20 rounded-xl p-5">
              <h3 className="text-sm font-bold text-purple-400 mb-1">�x:�️ Proteção contra DevTools</h3>
              ...
              <div className="grid grid-cols-1 gap-3">
                {([
                  { value: '1', label: 'Proteção ATIVADA', desc: 'Clientes são bloqueados ao abrir DevTools. Você recebe alerta.', icon: '�x' },
                  { value: '0', label: 'Proteção DESATIVADA', desc: 'DevTools liberado para todos os clientes. Use para gravar tela ou testar.', icon: '�x' },
                ] as const).map(opt => {
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
              <p className="text-blue-300 text-sm font-semibold mb-1">��️ Modo ADM na página Acompanhar</p>
...
function OgSettingsTab() {
  ...
  const uploadImageMut = trpc.ogSettings.uploadImage.useMutation({
    onSuccess: (data) => {
      toast.success("�S& Imagem salva com sucesso! A miniatura do WhatsApp foi atualizada.");
      setPreview(data.url);
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="relative w-full aspect-video bg-[#0a0a1a] flex items-center justify-center overflow-hidden">
            ...
            {uploadSuccess && (
              <div className="absolute bottom-2 left-2 right-2 flex items-center gap-1.5 bg-emerald-500/90 text-white text-xs font-semibold px-3 py-1.5 rounded-lg shadow-lg">
                <span>�S&</span> Imagem atualizada com sucesso!
              </div>
            )}
          </div>
          {/* Texto */}
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
        <p className="text-xs text-blue-200/80 font-semibold mb-1">�a�️ Importante</p>
...
const DEFAULT_WA_ORDER_TEMPLATE = `*H2 COLOMBIANO* � Atualização de Pedido
...
�x� *Senha de acesso:* {senha}
�a�️ _Não compartilhe esta senha com ninguém para evitar bloqueios de acesso._`;
...
const WA_ORDER_VARS = [
  {
    ...
    vars: [
      ...
      { label: "{cidade}", value: "{cidade}", desc: "Cidade e estado do cliente (ex: SÒO PAULO � SP)" },
...
function WaPreview({ template }: { template: string }) {
  const preview = template
    ...
    .replace(/\{descricao_status\}/gi, "�x� AGENDAMENTO DISPONÍVEL\n\n�S& A foto será realizada ao vivo no horário agendado.\n\n�S& Aparelho de trabalho preparado\n�S& Hard Reset concluído")
    .replace(/\{cadastro\}/gi, "*317")
    .replace(/\{pedido\}/gi, "#4000000")
    .replace(/\{servico\}/gi, "UBER APP � NOME ALEATORIO")
    .replace(/\{cidade\}/gi, "SÒO PAULO � SP")
  ...
  return (
    <div className="bg-[#0b141a] rounded-2xl p-4 border border-white/10">
      ...
      <div className="bg-[#1f2c34] rounded-xl rounded-tl-none px-4 py-3 max-w-xs ml-2 shadow-md">
        ...
        <p className="text-[10px] text-white/30 text-right mt-2">agora �S�S</p>
      </div>
    </div>
  );
}
...
function WhatsappOrderTemplateTab() {
  ...
  const saveMut = trpc.settings.saveWhatsappOrderTemplate.useMutation({
    onSuccess: () => { toast.success("�S& Template salvo com sucesso!"); utils.settings.getWhatsappOrderTemplate.invalidate(); },
    onError: () => toast.error("Erro ao salvar template"),
  });

  const [template, setTemplate] = useState(DEFAULT_WA_ORDER_TEMPLATE);
  const [showPreview, setShowPreview] = useState(true);
  const [expandedGroup, setExpandedGroup] = useState<string | null>("�x� Cliente");
...
// ============================================================
// TEMPLATE PADRÒO � MENSAGEM WHATSAPP DE DADOS DE LOGIN
// ============================================================
const DEFAULT_WA_LOGIN_TEMPLATE = `�x� Seus dados de acesso estão prontos!

Olá, {nome}!

Seu pedido já foi liberado.

�a�️ IMPORTANTE: Os dados de acesso não são enviados por mensagem. Eles devem ser resgatados exclusivamente através do site abaixo:

�xR� https://h2colombiano.com/acompanhar
...
�S& Acesse o site
�S& Informe seu telefone e a senha de 4 dígitos
�S& Os dados de acesso serão exibidos na página do seu pedido

�R Não tente acessar diretamente pelo aplicativo
�R Os dados não são fornecidos por WhatsApp

�x Por segurança, o resgate dos dados é realizado somente pela área do cliente.
...
function WhatsappLoginTemplateTab() {
  ...
  const saveMut = trpc.settings.saveWhatsappLoginTemplate.useMutation({
    onSuccess: () => { toast.success("�S& Template de login salvo com sucesso!"); utils.settings.getWhatsappLoginTemplate.invalidate(); },
    onError: () => toast.error("Erro ao salvar template"),
  });
          ...
          {showPreview && (
            <div className="bg-[#0b141a] rounded-2xl p-4 border border-white/10 max-h-[480px] overflow-y-auto">
              <div className="bg-[#202c33] rounded-xl rounded-tl-none px-4 py-3 max-w-xs shadow-md">
                ...
                <p className="text-[10px] text-[#8696a0] text-right mt-1">{new Date().toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })} �S�S</p>
              </div>
            </div>
          )}
        </div>
